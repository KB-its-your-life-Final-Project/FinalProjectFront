  ...
  <div>
    ...
    <div v-else>
      <div v-if="estateData">
        ...
        <div v-if="estateData.data.buildingName">건물 이름: {{ estateData.data.buildingName }}</div>
        <div v-if="estateData.data.buildYear">건축 년도: {{ estateData.data.buildYear }}</div>
        <div v-if="estateData.data.buildingType">건물 유형: {{ estateData.data.buildingType }}</div>

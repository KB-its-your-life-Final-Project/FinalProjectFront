...
<template>
  ...
  >
    <div class="flex bg-gray-200 rounded-full p-0.5 sm:p-1">
      <button
        v-for="opt in saleOptions" :key="opt"
        @click="selectSale(opt)"
        class="px-2 sm:px-3 py-0.5 sm:py-1 text-xs sm:text-sm
             font-medium rounded-full transition whitespace-nowrap"
...
<!--    <div class="h-6 w-px bg-gray-300 mx-2"></div>-->
    ...
    <div class="flex bg-gray-200 rounded-full p-0.5 sm:p-1">
      <button
        v-for="opt in propertyOptions" :key="opt"

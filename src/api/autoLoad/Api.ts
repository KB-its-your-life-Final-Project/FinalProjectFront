...
import {
  ...
  ApiResponseListYouthProgramDTO,
...
> extends HttpClient<SecurityDataType> {
   ...
   * No description
   *
   * @tags youth-program-controller
   * @name GetYouthProgramsUsingGet
   * @summary getYouthPrograms
   * @request GET:/api/youthprogram
   */
  getYouthProgramsUsingGet = (params: RequestParams = {}) =>
    this.request<ApiResponseListYouthProgramDTO, void>({
      path: `/api/youthprogram`,
      method: "GET",
      ...params,
    });
  /**
   ...
   *
   * @tags youth-program-controller
   * @name GetUnreadProgramsUsingGet
   * @summary getUnreadPrograms
   * @request GET:/api/youthprogram/list
   */
  getUnreadProgramsUsingGet = (
    query: {
      /**
       * memberId
       * @format int64
   ...
   * @summary markAsRead
   * @request POST:/api/youthprogram/read
   */
  markAsReadUsingPost = (
    query: {
      /**
   ...
   *
   * @tags youth-program-controller
   * @name SyncYouthProgramsUsingPost
   * @summary syncYouthPrograms
   * @request POST:/api/youthprogram/sync
   */
  syncYouthProgramsUsingPost = (params: RequestParams = {}) =>
    this.request<object, void>({
      path: `/api/youthprogram/sync`,
      method: "POST",
      type: ContentType.Json,
      ...params,
    });

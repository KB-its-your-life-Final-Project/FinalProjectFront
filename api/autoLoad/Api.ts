...
> extends HttpClient<SecurityDataType> {
   ...
   * @name SelectAllUsersUsingGet
   * @summary selectAllUsers
   * @request GET:/api/member
   */
  selectAllUsersUsingGet = (params: RequestParams = {}) =>
   ...
   *
   * @tags member-controller
   * @name LogoutUserUsingPost
   * @summary logoutUser
   * @request POST:/api/member/logout
   */
  logoutUserUsingPost = (params: RequestParams = {}) =>
    this.request<ApiResponseBoolean, void>({
   ...
   *
   * @tags member-controller
   * @name RegisterUserByEmailUsingPost
   * @summary registerUserByEmail
   * @request POST:/api/member/register/email
   */
  registerUserByEmailUsingPost = (
    query?: {
      email?: string;
      name?: string;
      password?: string;
   ...
   *
   * @tags member-controller
   * @name SelectUserByIdUsingGet
   * @summary selectUserById
   * @request GET:/api/member/{id}
   */
  selectUserByIdUsingGet = (id: number, params: RequestParams = {}) =>
    this.request<ApiResponseMemberDTO, void>({
      path: `/api/member/${id}`,
      method: "GET",
      ...params,
